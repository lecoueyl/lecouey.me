<template>
  <section class="container relative grid sm:grid-cols-6 gap-64 bg-neutral-100 pt-64">
    <TransitionReveal tag="h2" class="col-span-full pt-4 flex items-start">
      <span class="text-8xl">Works</span>
      <span class="pt-4 text-base font-normal text-neutral-500">(5)</span>
    </TransitionReveal>

    <div class="sticky top-1/2 sm:col-span-4 sm:col-start-2 col-span-full overflow-hidden">
      <div ref="title" class="w-full text-center text-4xl" />
    </div>

    <article
      :ref="(el) => setElementRef(el)"
      class="relative z-10 sm:col-span-4 sm:col-start-2 gap-6"
      data-title="title 1"
    >
